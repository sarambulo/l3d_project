...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='Toy', help='Dataset to use dataset', choices=['Toy', 'Shapenet'])
    ...
    parser.add_argument('--visIter', type=int, default=10)

    parser.add_argument('--learningRate',type=float, default=0.003)
    ...
    parser.add_argument('--disp', type=bool, default=False, help='Not used')
